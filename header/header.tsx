    ...
    return(
        ...
        <div className={style.header_block1}>
            ...
            <nav className={style.header_list}>
                <NavLink to="/Exchange" className={style.header_list}>Обмен и возврат</NavLink>
                <a className={style.header_list} onClick={() => setModal(true)}>Статус заказа</a>
                <NavLink to="/Shops" className={style.header_list}>Магазины</NavLink>
                <NavLink to="/Delivery" className={style.header_list}>Доставка</NavLink>
                <NavLink to="/Pawnshop" className={style.header_list}>Ломбард</NavLink>
               
            </nav>
        </div>
        <div className={style.header_block2}>
            <NavLink to="/" className={style.header_logo2}>
