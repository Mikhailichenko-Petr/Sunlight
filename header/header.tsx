    ...
    return(
        ...
        <div className={style.header_block1}>
            ...
            <nav className={style.header_list}>
                <Link to="/Exchange" className={style.header_list}>Обмен и возврат</Link>
                <a className={style.header_list} onClick={() => setModal(true)}>Статус заказа</a>
                <Link to="/Shops" className={style.header_list}>Магазины</Link>
                <Link to="/Delivery" className={style.header_list}>Доставка</Link>
                <Link to="/Pawnshop" className={style.header_list}>Ломбард</Link>
            </nav>
        </div>
        <div className={style.header_block2}>
            <Link to="/" className={style.header_logo2}>
            ...
            <nav className={style.sidebar_menu}>
                    <Link to="/Authorizations" className={style.NavLink}>
                    ...
                    <Link to="/Basket" className={style.NavLink}>
                        <div className={style.sidebar_box_icon}>
                        ...
                        <span className={style.basket_number}>{data}</span>
                    </Link>
                    <a className={style.sidebar_box_icon}>
                        ...
                        <p className={style.sidebar_link}>Избранное</p>
                    </a>
            </nav>
        </div>
        </header>
