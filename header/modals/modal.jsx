    ...
    return(
        <div className={style.mobile_menu__list}>
                       <ul>
                            ...
                            <Link to="/Diamonds" className={style.mobile_menu__item}><img src="https://g6.sunlight.net/media/content/desktop-menu/categories/1f0989e944b69b80825ea83d96cdea71328274d3.svg" alt="icon" width="30px"/> <p>Брелианты</p> </Link>
                            <Link to="/Rings" className={style.mobile_menu__item}><img src="https://g0.sunlight.net/media/content/desktop-menu/categories/9b98a6341b30c5f59ac49569d9c066e71b47acc8.svg" alt="icon" width="30px"/> <p>Кольца</p> </Link>
                            <Link to="/Earrings" className={style.mobile_menu__item}><img src="https://g5.sunlight.net/media/content/desktop-menu/categories/a31b320c3f61fe001b6cac0f8c9af71ead1b868d.svg" alt="icon" width="30px"/> <p>Серьги</p> </Link>
                            <Link to="/Neckleace" className={style.mobile_menu__item}><img src="https://g4.sunlight.net/media/content/desktop-menu/categories/e7bced08b4aeaa15cd203cd165c14db7cc4f1818.svg" alt="icon" width="30px"/> <p>Колье</p> </Link>
                            <Link to="/Bracelets" className={style.mobile_menu__item}><img src="https://g2.sunlight.net/media/content/desktop-menu/categories/552132e2aa71558ae807db2ca98bd65da5c4371d.svg" alt="icon" width="30px"/> <p>Браслеты</p> </Link>
                            <Link to="/Chains" className={style.mobile_menu__item}><img src="https://g6.sunlight.net/media/content/desktop-menu/categories/59245252fb427e483c28d915273845be22210ef4.svg" alt="icon" width="30px"/> <p>Цепи</p></Link>
                            <Link to="/Pendants" className={style.mobile_menu__item}><img src="https://g0.sunlight.net/media/content/desktop-menu/categories/a9c04ca9495a7d802a3530d8cb49bdf98772c2da.svg" alt="icon" width="30px"/> <p>Подвески</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g2.sunlight.net/media/content/desktop-menu/categories/a516fb1e20aa0f9b6f977e79a2d0941cb3ff1baf.svg" alt="icon" width="30px"/> <p>Броши</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g5.sunlight.net/media/content/desktop-menu/categories/bb267fbdb937a54afbf23e8c5c6fa7dfaeb2afd7.svg" alt="icon" width="30px"/> <p>Часы</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g6.sunlight.net/media/content/desktop-menu/categories/839ec265f1a77380de6f6655de60553855d440ab.svg" alt="icon" width="30px"/> <p>Коллекции</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g3.sunlight.net/media/content/desktop-menu/categories/c4886e9d911fd54a43b496e9c6093e674a1cd4d8.svg" alt="icon" width="30px"/> <p>Подарки</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g7.sunlight.net/media/content/desktop-menu/categories/1099d7151a12c078ccd9b72ab1026c28fb45e59c.svg" alt="icon" width="30px"/> <p>Свадьба</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g5.sunlight.net/media/content/desktop-menu/categories/38174640ad3d97f248690e45d35bfe7de84b10f1.svg" alt="icon" width="30px"/> <p>Для него</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g8.sunlight.net/media/content/desktop-menu/categories/17cbdd3eedb16af676e145214ca1fb9a51d35085.svg" alt="icon" width="30px"/> <p>Для детей</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g0.sunlight.net/media/content/desktop-menu/categories/7f1167c89647f28a05a3471a838d70a40c3114d9.svg" alt="icon" width="30px"/> <p>Талисманы</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g4.sunlight.net/media/content/desktop-menu/categories/09a94ea633d6c2a4a263bbb0e1ae489174d1edf1.svg" alt="icon" width="30px"/> <p>Религия</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g9.sunlight.net/media/content/desktop-menu/categories/4f8ce7892b9040f247b5c51b24ed426e75271ccb.svg" alt="icon" width="30px"/> <p>Для дома</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g1.sunlight.net/media/content/desktop-menu/categories/6c90bb90152ceb61db339d03acd34cd4377b9e7e.svg" alt="icon" width="30px"/> <p>Шармы</p> </Link>
                            <Link to="/AllDecorations" className={style.mobile_menu__item}><img src="https://g3.sunlight.net/media/content/desktop-menu/categories/be43a7b11b9b9733dbd3ac44d4208555bf7c638a.svg" alt="icon" width="30px"/> <p>Косметика</p> </Link>
                       </ul>
                       <div >
                           <div>
