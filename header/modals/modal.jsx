    ...
    return(
        <div className={style.mobile_menu__list}>
                       <ul>
                            ...
                            <Link to="/Necklace" className={style.mobile_menu__item}><img src="https://g4.sunlight.net/media/content/desktop-menu/categories/e7bced08b4aeaa15cd203cd165c14db7cc4f1818.svg" alt="icon" width="30px"/> <p>Колье</p> </Link>
